...
# slit the training data randomly into 90%-10% training-test sets for 100 iterations.
# Each iteration trains a model on 90% of the training set and tests on
...
# Generate the needed files for verification.
